...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_charybdis_4x6(KC_F12, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_GRV, KC_BTN4, KC_BTN2, KC_UP, KC_BTN1, KC_HOME, KC_END, KC_BTN1, KC_BTN3, KC_BTN2, KC_TRNS, KC_EQL, KC_TRNS, KC_BTN3, KC_LEFT, KC_DOWN, KC_RGHT, DRGSCRL, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_BSLS, KC_TRNS, KC_TRNS, KC_BTN5, KC_BSLS, S_D_MOD, DPI_MOD, KC_LBRC, KC_RBRC, KC_TRNS, KC_SPC, KC_LALT, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_TRNS, KC_DEL, SNP_TOG, KC_ENT, LT(2,KC_NO), LT(2,KC_NO)),
